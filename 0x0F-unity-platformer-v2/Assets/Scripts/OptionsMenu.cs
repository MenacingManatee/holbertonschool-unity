...
public class OptionsMenu : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach (Component b in buttons) {
            ...
            if (b.name.Substring(0, 5) == "KeyBi")
                bu.onClick.AddListener(delegate{KeyBindings();});
        }
    ...
    public void Back()
    {
        ...
        if (string.IsNullOrEmpty(prevScene) || prevScene == "KeyBindMenu")
            prevScene = "MainMenu";
    ...
    public void KeyBindings()
    {
        if (bgm != null)
                DontDestroyOnLoad(bgm);
        SceneManager.LoadScene("KeyBindMenu");
    }
}
